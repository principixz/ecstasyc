...
if(empty($host)){
	...
	if($ini_array['gestor']=='ORACLE'){
	$host= '(DESCRIPTION  = (ADDRESS=(PROTOCOL = TCP)(HOST = 127.0.0.1)(PORT = 151))(CONNECT_DATA = (SERVER = DEDICATED)(SERVICE_NAME = XE)))';
	}else{
	$host = $ini_array["host"];
	}
